...
function toggleMode() {
  ...
  // Pengaman: Jika elemen penting tidak ada, hentikan fungsi
  if (
    !formTitle ||
    !subtitle ||
    !btnText ||
...
document.addEventListener("click", (e) => {
  // Cek apakah elemen yang diklik adalah link di dalam #switchText
  if (e.target.matches("#switchText a")) {
    e.preventDefault(); // Mencegah link melakukan navigasi
    toggleMode(); // Panggil fungsi untuk beralih mode
  }
});
